...
public class view_doctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sh.getString("ip","");
        url = sh.getString("url","")+"android_view_doctor";
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for (int i = 0; i < js.length(); i++) {
                                    ...
                                    did[i] = u.getString("did"); // dbcolumn name in double quotes
                                ...
                                li.setAdapter(new custom_view_doctor(getApplicationContext(), did,name,designation,email,phone_no));//custom_view_service.xml and li is the listview object
