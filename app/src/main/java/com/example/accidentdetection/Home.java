...
import com.example.accidentdetection.databinding.ActivityHomeBinding;
...
//        Toast.makeText(this, ""+url, Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            ed.commit();
            ed.clear();
            Intent h = new Intent(getApplicationContext(),gpstracker.class);
            stopService(h);
            Intent k = new Intent(getApplicationContext(),ShakeService.class);
            stopService(k);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        int id = item.getItemId();
        if (id == R.id.nav_home){
            Intent i = new Intent(getApplicationContext(),view_nearby_hospital.class);
            startActivity(i);
        }
        else if(id == R.id.nav_gallery){
            Intent i = new Intent(getApplicationContext(),view_nearby_policestation.class);
            startActivity(i);
        }
        else if(id == R.id.nav_slideshow){
            Intent i = new Intent(getApplicationContext(),view_accident_detction.class);
            startActivity(i);
        }
